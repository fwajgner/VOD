namespace VOD.Domain.Requests.Video.Validators
{
    ...
    public class EditVideoRequestValidator : AbstractValidator<EditVideoRequest>
    {
        public EditVideoRequestValidator(IGenreService genreService, IKindService kindService)
        {
